			...
			function ( m_Event )
			{
				...
				if ( m_strFilter )
				{
					...
					m_Delay(
						...
						{
							$J.get(
								'https://www.valvesoftware.com/sv/jobs/job-search?search=' + m_strFilter,
								function ( m_Data )
								{
									...
									if ( m_Data.length > 0 )
									{
										$J.each(
											...
											{
												m_iCounter++;
												m_strResultsHtml += '<div class="job_opening col_4"><a href="https://www.valvesoftware.com/sv/jobs?job_id=' + m_rgJob[ 'reqid' ] + '"><h5 class="job_title">' + m_rgJob[ 'name' ] + '</h5></a></div>';
												if ( m_iCounter % 3 === 0 )
												{
									...
									else
									{
										...
										m_strResultsHtml += "<div class='col_12 job_opening no_results'><h5>" + m_strNoSearchResult + "<br><a href='https://www.valvesoftware.com/sv/jobs'>Did we miss something?</a></h5>"
									}
