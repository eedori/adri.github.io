...
var VsApp = function()
{
						...
						function( m_Event )
						{
							...
							$J.ajax(
								...
								function( xhr )
								{
									...
									if ( xhr.status === 413 )
									{
										m_rgErrors.push('Den bifogade filen är för stor.');
									}
									else
									{
										m_rgErrors.push('Ett oväntat fel uppstod när din ansökan skickades in.');
									}
	...
	function SetContext( strContext )
	{
		...
		console.info( 'Hello! You are looking at the console! If you are snooping, perhaps a job at security is for you.' );
	}
